...
async function createFriendFunctions() {
  console.log('🚀 Creating friend system database functions...');
  
  try {
    // Function 1: Get friendship status between two users
    console.log('📋 Creating get_friendship_status function...');
    ...
    console.log('👥 Creating get_user_friends function...');
    await supabase.rpc('exec_sql', {
      sql: `
    ...
    console.log('📥 Creating get_incoming_requests function...');
    await supabase.rpc('exec_sql', {
      sql: `
    ...
    console.log('📤 Creating get_outgoing_requests function...');
    await supabase.rpc('exec_sql', {
      sql: `
    ...
    console.log('✅ Friend system database functions created successfully!');
