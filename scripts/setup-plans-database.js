...
// Configuration
const SUPABASE_URL = 'https://nfzbvuyntzgszqdlsusj.supabase.co';
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5memJ2dXludHpnc3pxZGxzdXNqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzU2NzQ5NzQsImV4cCI6MjA1MTI1MDk3NH0.Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8';

const supabase = createClient(SUPABASE_URL, SUPABASE_ANON_KEY);

async function setupPlansDatabase() {
  console.log('🚀 Setting up plans database schema...');
  ...
  try {
    ...
    console.log('🎉 Plans database schema setup complete!');

  } catch (error) {
    console.error('❌ Error setting up plans database:', error);
    throw error;
  }
}
...
module.exports = { setupPlansDatabase }; 